...
const gates: Gate[] = [
  {
    ...
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvDguIu_4yattsALvtWad9Qn1ESuaZu5Dd8WxL8-fAn1zbjaKGrLNjqmw&s=10',
    span: 'sm:row-span-2',
  ...
  },
  {
    ...
    image: '/images/fellowships-hero.jpg',
    span: '',
