                ...
                >
                  <div className="relative h-[26rem] overflow-hidden">
                    <img
                      src={prog.image}
                      alt={prog.title}
                      className={`absolute inset-0 w-full h-full object-center transition-transform duration-700 group-hover:scale-105 ${prog.id === 'masterclass' || prog.id === 'music' ? 'object-contain' : 'object-cover'}`}
